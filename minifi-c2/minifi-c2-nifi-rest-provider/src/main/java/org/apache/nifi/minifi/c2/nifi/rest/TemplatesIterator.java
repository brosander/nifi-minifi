...
public class TemplatesIterator implements Iterator<Pair<String, String>>, Closeable {
    ...
    public TemplatesIterator(String nifiUrl, JsonFactory jsonFactory) throws ConfigurationProviderException, IOException {
        String templatesUrlString = nifiUrl + "/flow/templates";
        URL url;
        try {
            url = new URL(templatesUrlString);
        } catch (MalformedURLException e) {
            throw new ConfigurationProviderException("Malformed url: " + templatesUrlString, e);
        }

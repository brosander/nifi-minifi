...
public class ConfigSchemaV2 extends AbstractConfigSchemaV2 {
    ...
    public ConfigSchemaV2(Map map, List<String> validationIssues) {
        ...
        List<ProcessGroupSchemaV2> allProcessGroups = getAllProcessGroups(getProcessGroupSchema());
    ...
    public ConfigSchema convert() {
        ...
        putIfNotNull(result, FLOW_CONTROLLER_PROPS_KEY, getFlowControllerProperties());
        putIfNotNull(result, CORE_PROPS_KEY, getCoreProperties());
        putIfNotNull(result, FLOWFILE_REPO_KEY, getFlowfileRepositoryProperties());
        putIfNotNull(result, CONTENT_REPO_KEY, getContentRepositoryProperties());
        putIfNotNull(result, PROVENANCE_REPO_KEY, getProvenanceRepositorySchema());
        putIfNotNull(result, COMPONENT_STATUS_REPO_KEY, getComponentStatusRepositoryProperties());
        putIfNotNull(result, SECURITY_PROPS_KEY, getSecurityProperties());
